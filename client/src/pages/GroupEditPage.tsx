    ...
    <div className="p-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="inline-flex items-center gap-1 rounded-full bg-bg-tertiary border border-border px-2.5 py-0.5 text-xs font-medium text-text-muted">
          <FolderTree size={11} />
          {t('groups.deviceGroup')}
        </span>
      </div>

      {/* General */}
      <div className="rounded-lg border border-border bg-bg-secondary p-5 mb-6">
        <h2 className="text-sm font-semibold text-text-secondary uppercase tracking-wide mb-4">{t('groups.form.sectionGeneral')}</h2>
      ...
      <div className="mb-6">
        <NotificationBindingsPanel
          scope="group"
          scopeId={groupId}
          title={t('groups.detail.notifications')}
        />
      </div>
