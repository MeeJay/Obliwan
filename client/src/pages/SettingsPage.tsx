...
import type { SmtpServer, AppConfig, ObligateConfig } from '@obliwan/shared';
...
export function SettingsPage() {
  ...
  return (
    <div className="p-6 min-w-0 space-y-8">
      ...
      {/* ── Global operational settings (inherited by groups) ── */}
      <SettingsPanel scope="global" scopeId={null} title={t('settings.defaultSettings', { defaultValue: 'Default settings' })} />
